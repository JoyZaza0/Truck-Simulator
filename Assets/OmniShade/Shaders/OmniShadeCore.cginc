...
v2f vert (appdata_full v) {
	...
	o.nor_world = UnityObjectToWorldNormal(v.normal);
		...
		float4 pos_clip = 0;
			...
			pos_clip = o.pos_clip;
		#endif
		o.col_diffuse_add = AdditionalLightsVert(o.pos_world, o.nor_world, pos_clip, _DiffuseWrap, _DiffuseBrightness, _DiffuseContrast, meshRenderingLayers);
	#endif
		...
		half3 col_diffuse = 0;
			...
			if (IsLitMainLight(unity_LightData, meshRenderingLayers, false)) {
				...
				float4 pos_clip = 0;
					...
					pos_clip = i.pos_clip;
				#endif
				col_diffuse += AdditionalLightsFrag(i.pos_world, adjNor_world, pos_clip, _DiffuseWrap, _DiffuseBrightness, _DiffuseContrast, meshRenderingLayers);
			#endif
		#endif
