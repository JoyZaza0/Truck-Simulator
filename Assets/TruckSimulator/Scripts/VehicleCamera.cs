...
/// <summary>
///This script is the camera controller.
/// </summary>
...
namespace TruckSimulatorTemplate
{
    public class VehicleCamera : MonoBehaviour
    {
        ...
        private TruckController carScript;
        ...
        public void ShowCarUI()
        {
            ...
            thisAngle = (carScript.motorRPM / 20) - 127;
        ...
        void Start()
        {
            ...
            carScript = (TruckController)target.GetComponent<TruckController>();

            myRigidbody = target.GetComponent<Rigidbody>();

            cameraSwitchView = carScript.differentCameraViews;
